...
class Individual(object):
    def __init__(self, args, num_node_features, num_classes):
        ...
        self.hidden_dim = 0
        self.dropout = 0.0
        self.lr = 0.0  # 0.001 0.002 0.003 0.004 0.005 0.006 0.007 0.008 0.009 0.01
        self.weight_decay = 0.0  # 0.00001 0.00005  0.0001 0.0005  0.001 0.005
    ...
    def initialize(self, genotype=None, lr=None, weight_decay=None, dropout=None, hidden_dim=None):
        if genotype is not None:
            ...
            for _ in range(self.len):
                self.genotype.append(random.randint(0, 3))  # 基因，假设为0110001000
    ...
    def get_record(self, genotype):
        self.record = []  # 通过下面的片段，输出为[[0,1],[1,2],[0,3],[1,1],[0,3]]
        elem = genotype[0]  # 0或1
        num = 1  # elem的数量
        subs = 1  # genotype下标
